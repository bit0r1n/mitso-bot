...
import { Course, Day, Faculty, Form, Group } from './interfaces'
...
export class Parser {
  ...
  async getGroupSchedule(id: string, groupFilter?: GroupFilterOptions): Promise<Day[]> {
    const url = new URL(join(this.url, 'groups', encodeURIComponent(id), 'schedule'))
